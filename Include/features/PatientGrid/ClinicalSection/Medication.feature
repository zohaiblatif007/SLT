...
#		And I should see the newly added <Source_Type> and <Name> and <Frequency> and <Route> and <Start_Date> and <CPOE> and <eSent> and <Drug_Formulacy> and <Directions> medication on grid
 ...
 Examples:
     ...
     |Danial722, Hack722|    MMSL   |Humulin R U-500 KwikPen 500unit/ml Solution for Injection::100034|3 times a day|Auricular (otic)| 12102020 |Bpci, Provider| Yes| Yes |     Yes      |As per the doctor recommend|Changes saved successfully|successChanges saved successfully.Hide|
...
#		And I should see the newly added <Source_Type> and <Name> and <Frequency> and <Route> and <Start_Date> and <CPOE> and <eSent> and <Drug_Formulacy> and <Directions> medication on grid
 ...
 Examples:
     |    Patient       |Source_Type|              Name                 |  Frequency  |Route |Start_Date|Prescribed_By|CPOE|eSent|Drug_Formulacy|              Directions             |dynamicid|message|
     |Danial722, Hack722|    HPC    |Advanced life support mileag::A0390|Every 8 hours|Dental| 03172021 |Bpci, Provider| Yes|  No |      No      |Edit directions in case of medication|Changes saved successfully|successChanges saved successfully.Hide|
