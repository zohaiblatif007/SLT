...
#	  And I should see the deleted procedure order not present on grid
    ...
    |Danial722, Hack722|Latif, Zohaib |Procedure order deleted successfully|successProcedure order deleted successfully.Hide|
    #
