...
#		And I should see the newly added <Source> and <Procedure> and <Date> and <Target_Site> and <Status> and <Reason> and <Service_Delivery_Location> procedure result on grid
    ...
    | Danial722, Hack722|  HPC |Noninterest escort in non er::A0080|01012021|Abnormal hematopoietic cell (cell) :: 107677004|Completed|Breast cancer screening declined (situation)::1.2275351e+16| Procedure Results Added |adding|
...
#		 And I should see the newly added <Source> and <Procedure> and <Date> and <Target_Site> and <Status> and <Reason> and <Service_Delivery_Location> procedure result on grid
    ...
    Examples:
    |   Patient    |Source|          Procedure            |  Date  |                     Target_Site                      |Status|                          Reason                        |Service_Delivery_Location|module|
    |Danial722, Hack722 | ICD9 |THER ULT HEAD & NECK VES::00.01|03112021|Bone structure of tarsus (body structure) :: 108371006|Active|Accidental needle stick injury (disorder)::1.0850741e+16|Procedure Results Edited |editing|
...
#	  And I should see the deleted procedure result not present on grid
    ...
    |Danial722, Hack722| ICD9CM |deleting|
