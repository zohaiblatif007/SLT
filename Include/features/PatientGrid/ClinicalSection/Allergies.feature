...
#		And I should see the newly added allergy record <Type>, <Source>, <Allergy>, <Reaction>, <Severity>, <Status>, <Start_Date>, <End_Date> and <Comments> on grid
    ...
    |Danial722, Hack722|Allergy to substance|SNOMED|Allergy to insect venom (finding)|Edema of lower extremity (finding)::102572006|Moderate|Active| 01042021 |01232021|For a long time suffering|adding|
...
#		And I should see the newly added allergy record <Type>, <Source>, <Allergy>, <Reaction>, <Severity>, <Status>, <Start_Date>, <End_Date> and <Comments> on grid
    ...
    Examples:
    |   Patient    |    Type    |Source|      Allergy        |        Reaction        |Severity|Status|Start_Date|End_Date|         Comments             |module|
    |Danial722, Hack722|Food allergy|Custom|Allergy Set by custom|Apnea (finding)::1023001| Severe |Active| 03142021 |03172021|suffering due to allergies|editing|
...
#	  And I should see the deleted allergy not present on grid
    ...
    Examples:
    |   Patient  |    Type    |module|    
    |Danial722, Hack722|Food allergy|deleting|
