...
Examples:
     ...
     |Danial722, Hack722| ICD-9|THER ULTRASOUND OF HEART::00.02|01012021|Completed|     1    |  vaccination   |Immunization protects from disease|adding|
...
Examples:
     |    Patient   |Source|            Vaccine             |  Date  |Status|Lot_Number|Manufacture_Name|    Comment   |module|
     |Danial722, Hack722| CVX  |influenza, live, intranasal::111|03172021|Active|     15   |Medicine company|comments added|editing|
...
Examples:
     ...
     |Danial722, Hack722| CVX  |deleting|
