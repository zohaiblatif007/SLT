 ...
 Scenario Outline: Delete the specific record in lab results 
  Given I search <Patient> using global search
   ...
   Examples:    
     ...
     |Danial722, Hack722|Lipid Panel|Lab panel deleted successfully|successLab panel deleted successfullyHide|
