...
Background: 
  ...
  Given I search <Patient> using global search
    ...
    |Danial722, Hack722|01012021|1:30 AM| 98 |  80 |   70    |        80        |        125       |  88  |   72  |26 |21 |  98   |       99        |adding|
  ...
  Given I search <Patient> using global search
    ...
    Examples:
    |    Patient     |  Date  |  Time |Temp|Pulse|Resp_Rate|Sys_Bloodpressure|Dia_Bloodpressure|Weight| Height|BMI|BSA|O2_Sats|InhaledO2_Concern|module|
    |Danial722, Hack722|03112021|2:30 AM| 98|  70 |   60    |        90       |        140      |   90 |   68  |24 |22 |  95   |       96        |editing|
