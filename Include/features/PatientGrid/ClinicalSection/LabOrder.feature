...
Background: 
  ...
  Given I search <Patient> using global search
   ...
   |Danial722, Hack722|Quest Diagnostics|01/28/2021 13:57|Lipid Panel|Yes |  A00.0  |01/28/2021 13:57|Serum|     10    |Lab order added|Lab Order Saved Successfully|successLab Order Saved SuccessfullyHide|
...
#		And I should see the newly added <Laboratary> and <Panel> lab order on grid
    ...
    Examples:    
   |    Patient    |         Laboratary      |      Date      |      Panel      |STAT|Diagnosis|Collection_Date | Type |Specimen_No|      Notes    |dynamicid|message|
   |Danial722, Hack722|Whitehouse Analytical Lab|01/28/2021 13:57|Electrolyte Panel|Yes |  A00.9  |01/28/2021 13:57|Plasma|     10    |Lab order edit |Lab Order Saved Successfully|successLab Order Saved SuccessfullyHide|
...
#	  And I should see the deleted lab order not present on grid
   ...
   |Danial722, Hack722|Whitehouse Analytical Lab|Lab Order Deleted Successfully|successLab Order Deleted SuccessfullyHide|
