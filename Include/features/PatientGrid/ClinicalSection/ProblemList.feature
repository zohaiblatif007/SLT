...
#	 And I should see the newly added <Code_Name> and <Start_Date> and <Severity> and <Status> and <Rank> problem on grid
 ...
 Examples:
    ...
    |Danial722, Hack722| Cholera due to Vibrio cholerae 01, biovar cholerae::A00.0| 01072021   | Moderate |Condition| Active| Principal|  adding|
...
#	  *   I enter <Status> in problem status field
 ...
 Examples:
    |    Patient   |        Code_Name          | Start_Date |Severity|   Type  | Status|   Rank       | module  |
    |Danial722, Hack722|Cholera, unspecified::A00.9| 03082021   | Severe |Diagnosis| Active| Secondary| editing |
...
#	  And I should see the deleted problem not present on grid
 ...
 Examples:
    ...
    |Danial722, Hack722|Cholera, unspecified::A00.9| deleting |
